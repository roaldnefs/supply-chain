...
contract SupplyChain is Ownable, FisherRole, DistributorRole, RetailerRole, ConsumerRole {
    ...
    struct Item {
        ...
        address originFisherID; // Metamask-Ethereum address of the Farmer
    ...
    function fishItem(
        ...
        Item memory item = Item({
            sku: sku,
            upc: _upc,
            ownerID: payable(_originFisherID),
    ...
    {
        // Holds the previous owner of the Item
        address payable _owner = items[_upc].ownerID;
    ...
    function purchaseItem(uint _upc) onlyConsumer public payable
